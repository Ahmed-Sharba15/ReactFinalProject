...
import Shop from "./lastproject/pages/Home";
...
import Contact from "./lastproject/pages/Contact";
...
function App(){
    ...
    return (
      <div>
        ...
        <Route path="/Contact" element={<ShopCategory banner={kids_banner} category="Contact"/>} />
